...
<section class="content-header">
   ...
   <ol class="breadcrumb">
      ...
      <?php foreach($catsl as $key => $catl){ if($countl != $i){?>
        <li><a href="<?=site_url().admin?>/categories/details/<?=$grpid."/".$catl['url_name']?>"><?=$catl['name']?></a></li>
    <?php } $i++; }} ?>
        ...
        <!-- Categories List -->        
          <div class="panel panel-default">
            ...
            <div class="box-header">
               <div class="col-md-6 ">
                  <h3 class="box-title pull-left"><i class="fa fa-list"></i> <?=(isset($category))? $category->name: ''?> Category list</h3>
               </div>
               <div class="col-md-6">
                  ...
                  <?php foreach ($categories as $key => $cat) { ?>
                    <tr id="row_<?php echo $cat->id;?>">
                      ...
                      <td><?php if($cat->standard || !$cat->leaf) {?>
						  <a href="<?php echo site_url().admin.'categories/details/'.$grpid."/".$cat->url_name;?>"><?php echo $cat->name;?></a>
