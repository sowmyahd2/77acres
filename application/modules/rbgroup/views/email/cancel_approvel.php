...
<div style="margin:0 auto;width:820px;background:#fff;height:auto;padding:20px;">
	...
	<div style="width:465px;float:left">
		<h3 style="margin-top: 23px;color:#1492de;">fruit order cancellation request.</h3>
	</div>
	</header>
	...
	<!--second-->
	<p>
		Dear <?= $user_email->username; ?>,	<br><br>
			 <?php if($order_cancel['cancel_status']=='1'): ?>
					Your order cancellation  has been accepted. Please visit back. We will serve you better.  
			 <?php else: ?>
					Your order cancellation cannot be processed as your product has already been delivered.
			 <?php endif; ?>
