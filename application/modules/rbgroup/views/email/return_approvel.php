	...
	<p>
		Dear <?= $user_email->username; ?>,	<br><br>
			 <?php if($order_cancel['cancel_status']=='1'): ?>
					Your Return order request has been accepted. Please visit back. We will serve you better.  
			 <?php else: ?>
					Your Return order request cannot be processed as the Return Policy period is exceeded.
			 <?php endif; ?>
