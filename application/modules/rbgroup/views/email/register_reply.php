<html>
   ...
   <body style="background:#e2e2e2;">
	  ...
	  <header>
	   <div style="width:255px;float:left;">
            ...
            <!-- <div style="width:100px;float:left;">
               <img style="width:98px;height:auto;" src="http://delivertomyhome.com.au/resources/images/thank1.jpg"/>
            </div> -->
	  </header>  
	 <div style="border-bottom:1px solid #e2e2e2;clear:both;padding-top:20px;"></div>	  
	<!--second-->
	<p>Dear Customer, 
    <p>Thank you for registering with RB Group. <br></p>
     As a valued customer, you can expect high quality , great value products and a professional and efficient service.</p>
		...
		<p>Please Contact 9620557777 for account activation</p>
	...
	<!--third step-->
	 ...
	 <!--fourth step end-->	
	  <div style="border-bottom:1px solid #e2e2e2;clear:both;padding-top:20px;"></div>
         <p style="color:#1492de;margin-bottom:0px;text-align:center;">Copyright <?php echo date('Y'); ?> &copy; RB Group</p>
      </div>
