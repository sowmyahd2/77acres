...
<div style="margin:0 auto;width:820px;background:#fff;height:auto;padding:20px;">
	...
	<div style="width:465px;float:left">
		<h3 style="margin-top: 23px;color:#1492de;">fruit order cancel request.</h3>
	</div>
	</header>
	...
	<p>
		Dear <?= $user_email->username; ?>,	<br>		
			 Thank you for visiting fruit.com, your order cancellation request has been received. We look forward to serve you better in your next visit.<br>	
