...
<head>
	<meta charset="utf-8">
	<title><?php echo isset($page_title)?$page_title:'RB Group - Real Estate'; ?></title>
	<!-- Stylesheets -->
...
<body>
	...
	<div class="page-wrapper">
		<!-- Preloader -->
		<!--<div class="preloader d-none d-md-block" style="display:none"></div>-->

			<!--	<div class="flash-error">
			<div id="fixed_error">
				<span id="vpdisplay_message"></span>
				<span class="close errorblogclose_button">&times;</span>
			</div>
		</div>
				...
				<div class="auto-container">
					<div class="inner-container clearfix">
						...
						<div class="top-right">
							...
							<?php } else { ?>
							<div class="btn-box color-white d-inline"><a data-toggle="modal" data-target="#loginModal" data-backdrop="false" class="">Login / Register</a></div>
							<?php } ?>
							<div class="btn-box color-white d-inline header-drop">
							<?php if($this ->session -> userdata('citysession')) 
							{ ?>
								<a href="javascript:void(0);" data-toggle="modal" data-target="#cityModal" data-backdrop="false" class=""> <i class="la la-map-marker"></i> <span id="majorlocblock"><?php echo $this ->session -> userdata('citysession'); ?></span></a>
							<?php } else { ?>
			...
			<div class="header-lower">
				<div class="main-box">
					<div class="auto-container">
						<div class="inner-container clearfix">
							<div class="logo-box">
								<div class="logo"><a href="<?php echo base_url(); ?>"><img src="<?php echo base_url(IMAGES); ?>/logo.png" alt="logo" title="RB Group"></a></div>
							</div>
								...
								<nav class="main-menu navbar-expand-md navbar-left">
									...
									<div class="collapse navbar-collapse clearfix" id="navbarSupportedContent">
										<ul class="navigation clearfix">
											...
											<li class=""><a href="<?php echo base_url('agents'); ?>">RB Team</a></li>
											...
											<?php } else { ?>
											<li class="btn-box d-inline"><a data-toggle="modal" data-target="#loginModal" data-backdrop="false" href="javascript:void(0)" class="theme-btn btn-style-four nav-btn">Submit Property <span class="btn-badge">Free</span></a></li>
											<?php } ?>
										</ul>
									</div>
								</nav><!-- Main Menu End-->
			...
			<div class="sticky-header">
				<div class="auto-container clearfix">
					...
					<div class="logo pull-left">
						<a href="<?php echo base_url(); ?>"><img src="<?php echo base_url(IMAGES); ?>/logo-black.png" alt="logo" title="RB Group"></a>
					</div>
					<!--Right Col-->
