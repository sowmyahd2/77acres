...
<div class="dashboard">
                        ...
                        <div class="tab-pane fade p-3" id="two" role="tabpanel">
                           <div class="row seprate-row">
                              <div class="col-md-6 col-md-offset-3 col-sm-12 col-xs-12">
                                 <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Project Name" name="projectname" id="projectname"  >
                                 </div>
                              </div>
                              <!--col-md-12 ended-->
                           ...
                           <div class="row">
                            ...
                            <!--  <div class="col-md-3 col-sm-3 col-xs-12">
                              ...
                              <div class="col-md-3 col-sm-3 hidden-xs">
                                 <div class="form-group">
                                    ...
                                    <?php  
                                       ...
                                       $options = ' id="state_id" data-placeholder="Choose a State Name" data-show-subtext="true" data-live-search="true" class="form-control required" ';
                              ...
                              <div class="col-md-3 col-sm-3 hidden-xs">
                                 <div class="form-group">
                                    <label>City</label>
                                    <select id="city_id" name="cityname" data-placeholder="Choose a City..." class="form-control required" >
                              ...
                              <div class="col-md-3 col-sm-3 hidden-xs">
                                ...
                                <div class="visible-xs col-md-3 col-sm-3 col-xs-12">
                                 <div class="form-group">
                                    <label>State</label>
                                     <input list="states" placeholder="select state Name" class="form-control required state_id" name="statename" id="state_idxs">
  <datalist id="states" >
  <?php foreach ($statedtl as $browser): ?>
            <option value="<?php echo $browser; ?>">
        <?php endforeach; ?>
  </datalist>
                           </div>        
                                 </div>
                                    <div class="visible-xs col-md-3 col-sm-3 col-xs-12" id="city_idx">
                                 <div class="form-group">
                                    <label>City</label>
  ...
  <datalist id="cities" >
                                       ...
                                       <div class="visible-xs col-md-3 col-sm-3 col-xs-12" id="locality_idx">
                                 <div class="form-group">
                                    <label>Locality</label>
                                     <input list="areas" placeholder="select Locality" class="form-control required state_id" name="areaname" id="locality_idxs">
  <datalist id="areas" >
                ...
                ?>
                               ...
                               <div class="col-md-3 col-sm-3 col-xs-12">
                                    <div class="form-group">
                                    	<label>Price</label>
                                       <input type="text" class="form-control" placeholder="Price" required="required" name="price" id="price"  >
...
<script>
  ...
  var siteurl = $("#siteurl_data").val();
        ...
        var pincode = "570009"; // Replace with the desired pincode
  $.ajax({
            url:siteurl+"property/getlatlang",
            type: "GET",
