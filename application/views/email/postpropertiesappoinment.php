<html>
  ...
  <div style="width:600px;max-width:100%;border:1px solid #e8e8e8;">
    ...
    <div style="padding:5px 20px;font-size: 14px;background: #FFFFFF;">
      <h3>Dear Admin,</h3>
      <p>Please find the below details for enqury</p>
      <p>Name: <?php echo $name; ?></p>
      <p>Email ID: <?php echo $emailid; ?></p>
      <p>Phone: <?php echo $phonenumber; ?></p>
      <p>User Type: <?php echo $user_type; ?></p>
      <p>Resale: <?php echo $resale; ?></p>
      <p>Property Status: <?php echo $propertystatus; ?></p>
      <p>Rera Status: <?php echo $rerastatus; ?></p>
